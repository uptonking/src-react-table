...
class UdemyDataTableApp extends Component {
  constructor(props) {
    super(props);
      ...
      data: [
        {
          ...
          qualification: 'B.Com',
          rating: 3,
          profile: 'https://img.icons8.com/nolan/50/000000/user.png',
        },
        {
          id: 2,
          name: 'b',
    ...
    for (let i = 4; i <= 20; i++) {
      model.data.push({
        ...
        rating: i % 2 ? 3 : 4,
        profile: 'https://img.icons8.com/color/96/000000/activity-grid-2.png',
      });
    }
...
export default UdemyDataTableApp;
